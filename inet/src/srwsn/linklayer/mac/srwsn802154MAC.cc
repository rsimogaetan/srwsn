...
IE3ADDR srwsn802154Mac::addrCount = 0;

/** Default MAC PIB Attributes */
MAC_PIB srwsn802154Mac::MPIB =
{
...
Define_Module(srwsn802154Mac);

srwsn802154Mac::srwsn802154Mac()
{
...
/** Initialization */
void srwsn802154Mac::initialize(int stage)
{
	cSimpleModule::initialize(stage);
	EV << getParentModule()->getParentModule()->getFullName() << ": initializing srwsn802154Mac, stage=" << stage << endl;
...
void srwsn802154Mac::initializeQueueModule()
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
...
void srwsn802154Mac::receiveChangeNotification(int category, const cPolymorphic *details)
{
    Enter_Method_Silent();
...
/*************************** <Start star topology > *****************************/
//------------------------------------------------------------------------------------------------------------/
void srwsn802154Mac::startPANCoor()
{
...
void srwsn802154Mac::startDevice()
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
...
/*************************** <General Msg Handler> ******************************/
//-------------------------------------------------------------------------------/
void srwsn802154Mac::handleMessage(cMessage* msg)
{
...
void srwsn802154Mac::handleUpperMsg(cMessage* msg)
{
	UINT_8 index;
	IE3ADDR destAddr;
	bool gtsFound = false;
	...
	else		//  pkt destined for device
	{
		...
		srwsn802154Mac* macModule = check_and_cast<srwsn802154Mac *>(module);
...
void srwsn802154Mac::handleLowerMsg(cMessage* msg)
{
	bool noAck;
	int i;
...
void srwsn802154Mac::handleSelfMsg(cMessage* msg)
{
	switch (msg->getKind())
	{
...
void srwsn802154Mac::sendDown(Ieee802154Frame* frame)
{
...
void srwsn802154Mac::reqtMsgFromIFq()
{
	if (queueModule)
	{
...
//-------------------------------------------------------------------------------/
void srwsn802154Mac::handleBeacon(Ieee802154Frame* frame)
{
...
void srwsn802154Mac::handleData(Ieee802154Frame* frame)
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
...
void srwsn802154Mac::handleAck(Ieee802154Frame* frame)
{
...
void srwsn802154Mac::handleCommand(Ieee802154Frame* frame)
{
	...
	switch(tmpCmd->getCmdType())
	{
		...
		case Ieee802154_BEACON_REQUEST:	//Beacon request
			EV << "srwsn802154Mac::handleCommand\n";
...
bool srwsn802154Mac::frameFilter(Ieee802154Frame* frame)
// perform AMC frame filtering, return true if frame is filtered
{
	FrameCtrl frmCtrl = frame->getFrmCtrl();
	Ieee802154FrameType frmType = frmCtrl.frmType;
	/*
	srwsn802154MacCmdType cmdType;
	if (frmType == Ieee802154_CMD)
...
void srwsn802154Mac::constructACK(Ieee802154Frame* rxFrame)
...
// this function constructs an ACK and puts it in txAck
{
	...
	&& (check_and_cast<srwsn802154MacCmdType *>(rxFrame)->getCmdType() == Ieee802154_DATA_REQUEST))		//data request command
	{
...
/**************************** <MAC2PHY primitive> *******************************/
//-------------------------------------------------------------------------------/
void srwsn802154Mac::PLME_SET_TRX_STATE_request(PHYenum state)
{
...
void srwsn802154Mac::PLME_SET_request(PHYPIBenum attribute)
{
...
void srwsn802154Mac::PLME_CCA_request()
{
...
//-------------------------------------------------------------------------------/
void srwsn802154Mac::handleMacPhyPrimitive(int msgkind, cMessage* msg)
{
...
void srwsn802154Mac::handle_PD_DATA_confirm(PHYenum status)
{
	inTransmission = false;
...
void srwsn802154Mac::handle_PLME_CCA_confirm(PHYenum status)
{
...
void srwsn802154Mac::handle_PLME_SET_TRX_STATE_confirm(PHYenum status)
{
...
/***************************** <SSCS-MAC Primitive> *****************************/
//-------------------------------------------------------------------------------/
void srwsn802154Mac::MCPS_DATA_request(UINT_8 SrcAddrMode, UINT_16 SrcPANId, IE3ADDR SrcAddr,
...
void srwsn802154Mac::MCPS_DATA_confirm(MACenum status)
{
	// should report to upper layer here
	return;
}

void srwsn802154Mac::MCPS_DATA_indication(Ieee802154Frame* tmpData)
{
	if (tmpData->getIsGTS())
	{
		numRxGTSPkt++;
...
/***************************** <CSMA/CA Functions> ******************************/
//-------------------------------------------------------------------------------/
void srwsn802154Mac::csmacaEntry(char pktType)
{
...
void srwsn802154Mac::csmacaResume()
{
	bool ackReq;
...
void srwsn802154Mac::csmacaStart(bool firsttime, Ieee802154Frame* frame, bool ackReq)
{
	bool backoff;
...
void srwsn802154Mac::csmacaCancel()
{
...
void srwsn802154Mac::csmacaCallBack(PHYenum status)
{
	if (((!txBcnCmd)||(waitBcnCmdAck))
...
void srwsn802154Mac::csmacaReset(bool bcnEnabled)
{
	if (bcnEnabled)
	{
		NB = 0;
...
simtime_t srwsn802154Mac::csmacaAdjustTime(simtime_t wtime)
{
...
simtime_t srwsn802154Mac::csmacaLocateBoundary(bool toParent, simtime_t wtime)
{
	int align;
...
bool srwsn802154Mac::csmacaCanProceed(simtime_t wtime, bool afterCCA)
{
	bool ok;
...
simtime_t srwsn802154Mac::getFinalCAP(char trxType)
{
...
void srwsn802154Mac::csmaca_handle_RX_ON_confirm(PHYenum status)
{
	simtime_t now, wtime;
...
void srwsn802154Mac::csmacaTrxBeacon(char trx)
...
/***************************** <Timer starter> **********************************/
//-------------------------------------------------------------------------------/
void srwsn802154Mac::startBackoffTimer(simtime_t wtime)
{
...
void srwsn802154Mac::startDeferCCATimer(simtime_t wtime)
{
...
void srwsn802154Mac::startBcnRxTimer()
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
...
void srwsn802154Mac::startBcnTxTimer(bool txFirstBcn, simtime_t startTime)
{
...
void srwsn802154Mac::startAckTimeoutTimer()
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
...
void srwsn802154Mac::startTxAckBoundTimer(simtime_t wtime)
{
...
void srwsn802154Mac::startTxCmdDataBoundTimer(simtime_t wtime)
{
...
void srwsn802154Mac::startIfsTimer(bool sifs)
{
	simtime_t wtime;
	if (sifs)  					// SIFS
...
void srwsn802154Mac::startTxSDTimer()
...
void srwsn802154Mac::startRxSDTimer()
...
/******************************* <Timer Handler> ********************************/
//--------------------------------------------------------------------------------/
void srwsn802154Mac::handleBackoffTimer()
{
...
void srwsn802154Mac::handleDeferCCATimer()
{
	taskP.taskStatus(TP_CCA_CSMACA) = true;
	EV << "[MAC-TASK]: TP_CCA_CSMACA = true" << endl;
	PLME_CCA_request();
...
void srwsn802154Mac::handleBcnRxTimer()
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
...
void srwsn802154Mac::handleBcnTxTimer()
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
...
void srwsn802154Mac::handleAckTimeoutTimer()
{
...
void srwsn802154Mac::handleTxAckBoundTimer()
{
	if (!beaconWaitingTx)
...
void srwsn802154Mac::handleTxCmdDataBoundTimer()
...
void srwsn802154Mac::handleIfsTimer()
...
void srwsn802154Mac::handleSDTimer()		// we must make sure that outgoing CAP and incoming CAP never overlap
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
...
//-------------------------------------------------------------------------------/
void srwsn802154Mac::taskSuccess(char type, bool csmacaRes)
{
	UINT_16 t_CAP;
	UINT_8 ifs;
	simtime_t tmpf;
...
void srwsn802154Mac::taskFailed(char type, MACenum status, bool csmacaRes)
{
	if ((type == 'b')	//beacon
	|| (type == 'a')	//ack.
	|| (type == 'c'))	//command
...
void srwsn802154Mac::checkTaskOverflow(Ieee802154MacTaskType task)
...
void srwsn802154Mac::FSM_MCPS_DATA_request(PHYenum pStatus, MACenum mStatus)
{
	Ieee802154MacTaskType task = TP_MCPS_DATA_REQUEST;
...
void srwsn802154Mac::dispatch(PHYenum pStatus, const char *frFunc, PHYenum req_state, MACenum mStatus)
{
	FrameCtrl frmCtrl;
	UINT_8 ifs;
	bool isSIFS = false;
...
/****************************** <Utility Functions> *****************************/
//-------------------------------------------------------------------------------/
int srwsn802154Mac::calFrmByteLength(Ieee802154Frame* frame)
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
...
int srwsn802154Mac::calMHRByteLength(UINT_8 addrModeSum)
{
	switch(addrModeSum)
	{
		case 0:
...
simtime_t srwsn802154Mac::calDuration(Ieee802154Frame* frame)
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
...
double srwsn802154Mac::getRate(char bitOrSymbol)
{
	double rate;
...
bool srwsn802154Mac::toParent(Ieee802154Frame* frame)
{
 ...
 */
void srwsn802154Mac::gtsScheduler()
{
	UINT_8 t_SO;
...
void srwsn802154Mac::startGtsTimer(simtime_t w_time)
{
...
void srwsn802154Mac::handleGtsTimer()
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
 ...
 */
UINT_8 srwsn802154Mac::gts_request_cmd(UINT_16 macShortAddr, UINT_8 length, bool isReceive)
{
	Enter_Method_Silent();
	UINT_8 startSlot;
	UINT_32 t_cap;
...
void srwsn802154Mac::startFinalCapTimer(simtime_t w_time)
{
...
void srwsn802154Mac::handleFinalCapTimer()
{
...
UINT_16 srwsn802154Mac::associate_request_cmd(IE3ADDR extAddr, const DevCapability& capaInfo)
{
	EV << "srwsn802154Mac::"<< __FUNCTION__ <<"\n";
 ...
 */
bool srwsn802154Mac::gtsCanProceed()
{
	simtime_t t_left;
